...
|-----------|---------|---------|
| `bitfrog-spec-reviewer` | brainstorm | Independent design spec review |
| `bitfrog-code-reviewer` | review | Independent code quality review (互省) |
| `bitfrog-task-worker` | execute | Parallel task execution with TDD |
